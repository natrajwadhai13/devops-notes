...
# 🔐 **Network Security – Interview Q&A (Azure Focused)**
...
## **3️⃣ Difference between NSG and Azure Firewall?**
...
## **4️⃣ What is Azure DDoS Protection?**
...
## **8️⃣ What is a Private Endpoint?**
...
## **9️⃣ Service Endpoint vs Private Endpoint?**
...
## **1️⃣1️⃣ What is Application Gateway?**
...
## **1️⃣3️⃣ What is Azure Firewall used for?**
...
## **1️⃣4️⃣ How do you secure a VM in Azure?**
...
## **1️⃣5️⃣ What is Zero Trust Security?**

**Answer:**
Never trust, always verify — security based on **identity, device, and least privilege**.

---

## **1️⃣6️⃣ How is traffic secured between VNets and On-Prem?**
...
## **1️⃣7️⃣ What is Network Watcher?**
...
## **1️⃣8️⃣ What ports are commonly opened for web apps?**
...
## **1️⃣9️⃣ How does Azure protect against lateral movement?**
...
## **2️⃣0️⃣ Real-World Scenario Question**
...
# 🔐 Scenario-Based Network Security Q&A (Detailed & Rearranged)
...
* VPN → Small / medium workloads
* ExpressRoute → Enterprise / production critical systems
...
2. Map public IP + port → private IP + port
