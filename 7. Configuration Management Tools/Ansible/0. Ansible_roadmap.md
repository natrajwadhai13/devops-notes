...
Topics: Host groups, Child groups, Variables, Group Variables, Host Variables


## Dynamic Inventory

Topics: AWS EC2 Inventory, Azure VM Inventory, VMware Inventory, OpenStack Inventory, Custom Inventory Scripts
...
Module name : -m : ping, Copy, Shell, Command


Module arguments: -a : Service, Package, User, Group, Cron, File
...
Basics, Indentation, Data Types, Variables, Lists, Dictionary, Comments, Anchors, Aliases, Multi-line Strings
